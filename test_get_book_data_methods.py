...
class TestGetBookDataMethods(unittest.TestCase):
    ...
    def test_get_authors(self):
        ...
        self.assertEqual(get_authors(self.test_volume), "Dean Nicholson")


    def test_get_title(self):
        # tests that get_title retrieves the title from the volume
        self.assertEqual(get_title(self.test_volume), "Nala's World")


    def test_get_publisher(self):
        # tests that get_publisher retrieves the correct publisher from the vol
        self.assertEqual(get_publisher(self.test_volume), 'Hachette UK')
